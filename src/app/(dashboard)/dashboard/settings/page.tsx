            ...
            <div className="space-y-6 max-w-2xl">
                ...
                >
                    ...
                    <div className="flex flex-col gap-6">
                            ...
                            <div className="flex gap-3">
                                <button
                                    ...
                                    className={`flex-1 py-2.5 rounded-lg border text-sm transition-all ${status === "available"
                                            ...
                                            : "border-gray-200 dark:border-gray-800 text-(--text-secondary) hover:border-gray-400"
                                        }`}
                                >
                                    Taking Projects
                                </button>
                        ...
                        {status === "available" && (
                            <div className="flex flex-col gap-2">
                                <label className="text-xs text-(--text-secondary) font-medium">Remaining Slots (0 = Unlimited Profile view)</label>
